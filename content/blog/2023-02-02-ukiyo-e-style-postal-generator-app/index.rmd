...
[What is unconditional image generation?](https://huggingface.co/tasks/unconditional-image-generation)
...
There are important elemenets to take into account:

* We use gaussian distributions for both processes, eah the lovely normal distribution $\mathcal{N}(\mu, \sigma)$
