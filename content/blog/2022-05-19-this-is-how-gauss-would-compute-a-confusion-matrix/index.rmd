...
Some classification model gives us the predicted label each observation in the vector $\hat{\boldsymbol y} = [2, 0, 2, 0]$,
...
you can see in the following code. Below I used the canonical notation for name the
