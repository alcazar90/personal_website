...
ajustar los parámetros por cada época especificada pero ajustando con 
mayor velocidad los parámetros de las últimas que los de las primeras, dado
...
La librería es de alto nivel y tiene abstracciones de la mayoría de los 
componentes de entrenar un modelo. Destacable la abstracción en el núcleo
