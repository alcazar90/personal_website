...
<a href="https://colab.research.google.com/drive/1KDAbU3eW-fOxAYmp0eiQFbuuRmZARdqq?usp=sharing">
...
Let's code an example; I will replicate figure 5.4 from the [Mathematics for Machine Learning](https://mml-book.github.io/book/mml-book.pdf) book.
...
[JAX](https://jax.readthedocs.io/en/latest/index.html) is a python library that 
...
Let's start with an [example](https://github.com/hips/autograd) used by the `autograd`
...
Computing higher-order derivatives can be computationally expensive. Read the paper ["Taylor-Mode Automatic Differentiation for Higher-Order Derivatives in JAX"](https://openreview.net/pdf?id=SkxEF3FNPH)
...
[discussion](https://github.com/google/jax/issues/520).
...
You can read more about `jax.make_jaxpr` in the [documentation](https://jax.readthedocs.io/en/latest/notebooks/Writing_custom_interpreters_in_Jax.html)
...
1. [What's automatic differentiation video](https://www.youtube.com/watch?v=wG_nF1awSS)
2. [JAX's tutorial by Mat Kelcey](http://matpalm.com/blog/ymxb_pod_slice) showing more about
parallel computing using JAX
3. [Automatic Differentiation, Deep Learning Summer School Montreal 2017 (Matthew Jonhson)](http://videolectures.net/deeplearning2017_johnson_automatic_differentiation/); another seminar about the topic [JAX seminar](https://www.youtube.com/watch?v=mVf3HJ6gND)
...
represent a lot of array operations using index notation. Look this [video](https://www.youtube.com/watch?v=pkVwUVEHmfI) for a detail explanation and the
[documentation](https://numpy.org/doc/stable/reference/generated/numpy.einsum.html).
...
```python
jax.asarray(jax.jacfwd(g, argnums=(0,1))(1.0, 2.0))
