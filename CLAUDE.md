...
6. Copy `content/static/` verbatim into `public/`, then `.image-cache/` on top of it — originals ship alongside their derivatives so the full-resolution links resolve and no previously-published URL breaks.
